...
const EmailConfirmationContentView = ({
	option,
		...
		case 'initial':
			...
			return (
				<div className={'auth__container__form__block'}>
					...
					<div
						className={
							'auth__container__form__block--confirmation'
						}>
						<InfoCircleOutlined />
						<h3>Требуется подтверждение аккаунта</h3>
						<p>
							На Вашу почту отправлено письмо с ссылкой для
				...
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<p>
							...
							Ожидайте ответа, в случае успеха, вы будут
							перенаправлены автоматически
						</p>
					</div>
				</div>
			);
			...
			return (
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<img
							src={registrationReject}
							alt="Registration reject"
						/>
						<br />
						<p>
							Вы уверены, что хотите отменить регистацию? Для
							удаления аккаунта, перейдите
							<b onClick={onCancelRegistration}> по ссылке</b>.
							Если вы хотите продолжить регистацию, то{' '}
							<b onClick={onVerifyUser}>перейдите сюда</b>.
						</p>
					</div>
				</div>
			);
				...
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<img
							...
							alt="Registration reject"
						/>
						<h3>Аккаунт был успешно удален</h3>
						<br />
						<p>
							<b>На главную</b>
						</p>
				...
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<img
							...
							alt="Registration reject"
						/>
						<h3>Ожидайте ответа сервера</h3>
						<p>
							Запрос на сервер был выслан. Ожидайте завершения
							операции
						</p>
					</div>
				</div>
			...
			return (
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<p>
							Произошел сбой на сервере, в данный момент операция
							не может быть выполнена. Пожайлуста, попробуйте
							повторить позже
						</p>
					</div>
				</div>
			...
			return (
				<div className={'auth__container__form__block'}>
					...
					<div
						...
						<p>
							В данный момент операция не может быть выполнена.
							Пожайлуста, попробуйте повторить позже
						</p>
					</div>
				</div>
			);
