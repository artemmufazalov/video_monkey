...
const features = {
	free: [
		'Профессиональные инструменты обработки фото и видео',
		...
		<div className={'mainPage'}>
			<section className={'mainPage__top'}>
				<div className={'mainPage__top__content'}>
					<div className={'mainPage__top__content__top'}>
						<img
							src={softwareLogo}
							className={'mainPage__top__content__top__logo'}
							alt={'software logo'}
						/>
						<span className={'mainPage__top__content__top__text'}>
							<div
								className={
									'mainPage__top__content__top__text__name'
								}>
								Video Monkey 2020
							</div>
							<div
								className={
									'mainPage__top__content__top__text__phrase'
								}>
					...
					<NavLink to={'/products'}>
						<span className={'mainPage__top__content__tryButton'}>
			...
			<section className={'mainPage__photosAndText'}>
				<div className={'mainPage__photosAndText__item'}>
					<img
						src={cameraImg}
						className={'mainPage__photosAndText__item__photo'}
						alt={'camera'}
					/>
					<span className={'mainPage__photosAndText__item__content'}>
						<div
							className={
								'mainPage__photosAndText__item__content__header'
							}>
							Любая камера. Любой формат. Любая платформа
						</div>
						<div
							className={
								'mainPage__photosAndText__item__content__text'
							}>
							Программа поддерживает обработку видео в формате 8к.
							Работает одинаково хорошо на Windows, Mac OS или
							Linux. Поддерживает все распространенные форматы
							файлов и видео. Программа адаптирована под работу
							даже на слабых компьютерах
						</div>
					</span>
				</div>
				<div className={'mainPage__photosAndText__item'}>
					<span className={'mainPage__photosAndText__item__content'}>
						...
						<div
							...
							Профессиональный пакет позволяет получить доступ к
							синхронизации данных и настроек пользователя через
							единую облачную платформу. Модульная архитектура
							позволяет получать доступ к новейшим решения для
							видеобработки по щелчку мыши
						</div>
					</span>
					<img
						src={workingSpaceImg}
				...
				<div className={'mainPage__photosAndText__item'}>
					...
					<span className={'mainPage__photosAndText__item__content'}>
						...
						<div
							...
							Набор инструментов достаточно прост чтобы в нем
							разобраться, все версии включают в себя достаточно
							обширный список инструкций, охватывающий все функции
							программы. Также, для всех, купивших полную версию,
							доступен курс по видеобработке от команды
							профессионалов Video Monkey
						</div>
					</span>
				</div>
			...
			<section className={'mainPage__products'}>
				<div className={'mainPage__products__column'}>
					<div className={'mainPage__products__column__header'}>
						Video Monkey Free
					</div>
					<div className={'mainPage__products__column__price'}>
						Бесплатно
					</div>
					<div className={'mainPage__products__column__features'}>
						{features.free.map((text, idx) => (
							<div
								key={idx}
								className={
									'mainPage__products__column__features__item'
								}>
				...
				<div className={'mainPage__products__column'}>
					<div className={'mainPage__products__column__header'}>
						Video Monkey Pro 365
					</div>
					<div className={'mainPage__products__column__price'}>
						{' '}
						690 рублей ежемесячно
					</div>
					<div className={'mainPage__products__column__features'}>
						{features.pro.map((text, idx) => (
							<div
